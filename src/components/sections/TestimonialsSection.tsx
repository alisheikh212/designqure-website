...
const testimonials: Testimonial[] = [
  {
    ...
    name: 'Hao, CEO@Personal Projectors',
    tone: 'ink',
    size: 'feature',
    motion: 'up',
  ...
  {
    label: 'LANDING PAGE',
    quote: 'The page finally explained our offer clearly.',
    ...
    name: 'Liam, Founder@MMP Detailing',
    tone: 'lime',
    size: 'medium',
    motion: 'right',
  ...
  },
  {
    ...
    name: 'Nadel Frock, Independent Consultant',
    tone: 'orange',
    size: 'small',
    motion: 'left',
  ...
  },
  {
    ...
    name: 'Hassaan CMO@CollectorsHub',
    tone: 'blue',
    size: 'small',
    motion: 'up',
    className: 'md:col-span-1 lg:col-span-4',
